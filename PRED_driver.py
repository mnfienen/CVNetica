...
print 'reading in base case --> {0}'.format(cdat.probpars.baseCAS)
cdat.read_cas_file(cdat.probpars.baseCAS)
print 'finished reading {0}'.format(cdat.probpars.baseCAS)

# read in the data from a prediction cas file
print 'reading in base case --> {0}'.format(cdat.probpars.valCAS)
cdat.read_pred_cas_file(cdat.probpars.valCAS)
print 'finished reading {0}'.format(cdat.probpars.valCAS)
...
if cdat.probpars.rebin_flag:
    ...
    cdat.UpdateNeticaBinThresholds(False)
